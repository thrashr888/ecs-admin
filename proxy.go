...
func main() {
    ...
    http_addr := flag.String("httpaddr", ":8082", "proxy http listen address")
    https_addr := flag.String("httpsaddr", ":8081", "proxy https listen address")
    flag.Parse()
    ...
    proxy.NonproxyHandler = http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
        ...
        req.URL.Scheme = "http"
        req.URL.Host = "ecs.us-east-1.amazonaws.com"
    ...
    for {
        ...
        go func(c net.Conn) {
            ...
            connectReq := &http.Request{
                Method: "CONNECT",
                URL: &url.URL{
                    Opaque: "ecs.us-east-1.amazonaws.com",
                    Host:   net.JoinHostPort("ecs.us-east-1.amazonaws.com", "443"),
                },
